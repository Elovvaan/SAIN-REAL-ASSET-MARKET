...
function handleError(res,error){const message=error?.message||'Unexpected settlement rail error.';return res.status(/not found/i.test(message)?404:400).json({error:message});}
