...
const TIER_WORKSPACES={
  UNIVERSAL:{label:'Universal',title:'Universal Home',intro:'Browse, participate, track positions, and begin onboarding an asset from your free Universal Account.',nav:['marketplace','onboarding','positions','activity'],actions:[['Browse opportunities','Open the marketplace and compare productive opportunities.','marketplace'],['Onboard an Asset','Start a separate asset verification application.','onboarding'],['My Positions','Track active, pending, and settled positions.','positions'],['Add Capability','Expand into Asset Provider or Market Professional tools.','capabilities']]},
  ASSET_PROVIDER:{label:'Asset Provider',title:'Provider Home',intro:'Bring productive assets into SRA and move them through onboarding, verification, projects, and marketplace publishing.',nav:['onboarding','assets','verified','projects','instruments','completion'],actions:[['Onboard an Asset','Present an asset and its private evidence for verification.','onboarding'],['My Asset Accounts','Open permanent asset records connected to this provider.','assets'],['My Projects','Track projects, publishing, and completion activity.','projects']]},
