(() => {
  ...
  function style() {
    ...
    node.textContent = `
      ...
      @media(max-width:800px){.funding-metrics,.funding-intake-grid,.funding-detail-grid,.startup-section,.applicant-mode,.applicant-manual{grid-template-columns:1fr}.funding-ops-row{grid-template-columns:1fr}.startup-use-row,.startup-checks{grid-template-columns:1fr}}
    `;
