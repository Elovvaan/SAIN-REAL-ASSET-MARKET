...
function requiresSession(req){return isProductionProtected(req.path)||WRITE_METHODS.has(req.method)||isFinancingAvailabilityLetter(req.path)||isParticipantFundingSelfService(req);}
